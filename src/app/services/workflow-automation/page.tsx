...
const service = getServiceBySlug('workflow-automation')!;
...
export default function WorkflowAutomationPage() {
  const relatedServices = services.filter(s => s.slug !== 'workflow-automation').slice(0, 3);
        ...
        <Container>
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-primary-100 mb-8">
              Let's identify time-consuming tasks and build automation that saves you hours every week.
            </p>
