...
const service = getServiceBySlug('security-compliance')!;
...
export default function SecurityCompliancePage() {
  const relatedServices = services.filter(s => s.slug !== 'security-compliance').slice(0, 3);
        ...
        <Container>
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-primary-100 mb-8">
              Let's assess your security posture and implement protection that gives you peace of mind.
            </p>
