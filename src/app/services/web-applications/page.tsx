...
export default function WebApplicationsPage() {
  const relatedServices = services.filter(s => s.slug !== 'web-applications').slice(0, 3);
        ...
        <Container>
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-primary-100 mb-8">
              Let's discuss how we can make your website faster, more secure, and more effective.
            </p>
